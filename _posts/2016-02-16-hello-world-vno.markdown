---
layout: post
title: Hello World - 张科测试
date: 2016-02-16 15:32:24.000000000 +09:00
---

#### What's this

[张科](https://github.com/onevcat/vno-jekyll) is a theme for [张科](http://jekyllrb.com). It is a port of my Ghost theme [vno](https://github.com/onevcat/vno), which is originally developed from [Dale Anthony's Uno](https://github.com/daleanthony/uno).
...
Your site with `张科` enabled should be accessible in http://127.0.0.1:4000.
